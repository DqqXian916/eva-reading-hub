...
.word-side-list { width: 250px; height: 100%; border-right: 1px solid #f1f5f9; display: flex; flex-direction: column; background: #ffffff; flex-shrink: 0; }
...
.hidden-trigger { cursor: help; padding: 2px 4px; border-radius: 4px; transition: all 0.2s ease; user-select: none; }
...
.progress-info { display: flex; align-items: center; gap: 8px; margin-top: 8px; }
